## docker of watermark-detection-dev
...
- build docker
    ```shell
    docker build . -t samge/watermark-detection-dev-base -f .devcontainer/Dockerfile-dev-base --build-arg PROXY=http://192.168.50.48:7890
    ```

- upload
    ```shell
    docker push samge/watermark-detection-dev-base
    ```
